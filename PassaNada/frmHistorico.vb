Public Class frmHistorico
    Private Sub FecharToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles mnFechar.Click
    ...
    Private Sub listarDados()
        ...
        sql = "
        SELECT V.PK_VISITA, V.DATA, V.HORA, V.VISITANTE, V.CPF CPF_V, V.WHATSAPP, V.PLACA,
        ...
        WHERE V.DATA LIKE '%" & txtBuscar.Text & "%'
                ...
                OR V.PLACA LIKE '%" & txtBuscar.Text & "%'
        ...
        If vgRegistros.RecordCount > 0 Then
            While Not vgRegistros.EOF
                ...
                With lsvDados.Items.Add(item)
                    ...
                    .SubItems.Add(vgRegistros("PLACA").Value)
